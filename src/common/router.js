...
export const getRouterData = (app) => {
  const routerConfig = {
    ...
    '/monitor/depend': {
      component: dynamicWrapper(app, [], () => import('../routes/Depend/Depend')),
    },
    '/monitor/overview': {
      component: dynamicWrapper(app, [], () => import('../routes/Visual/Overview')),
    },
    '/monitor/appDetail': {
      component: dynamicWrapper(app, [], () => import('../routes/Visual/AppDetail')),
    }
  };
